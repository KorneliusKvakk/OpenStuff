...
We use  OpenAI Gymnasium to create the environment: https://gymnasium.farama.org/
...
class Env(gym.Env):
    def __init__(self):
        ...
        self.obs_min = [0,     0,   0,    0]
        self.obs_max = [10, 1500, 360, 1500]

        # Normalized observation ranges, used for defining the observation space for the agent
        self.obs_norm_min = [0, 0, 0, 0]
        self.obs_norm_max = [1, 1, 1, 1]
