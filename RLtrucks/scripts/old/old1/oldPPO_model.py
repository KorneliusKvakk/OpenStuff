...
total_timesteps = 1000 * env.episode_length # total number of training time steps
reward_threshold = 3 # reward threshold at which to stop training
eval_freq = 20 * env.episode_length # evaluation frequency in time steps
