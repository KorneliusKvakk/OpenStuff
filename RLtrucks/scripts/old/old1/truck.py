...
class Truck:
    ...
    def calculate_velocity(self):
        self.velocity_kmpm = self.velocity_kmpm_0 + self.velocity_kmpm_0 * 0.0005 * (self.capacity_kg_0 - self.capacity_kg)
    ...
    def draw_truck(self):
        ...
        # img_truck_title = FONT_SMALL.render(str_truck_title, True, COLOR_FONT_BLACK)
