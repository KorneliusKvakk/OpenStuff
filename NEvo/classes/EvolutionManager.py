...
This class defines the neural evolution manager
"""
...
class EvolutionManager:
    ...
    def GenerateGenesisGenome(self):
        ...
        self.genesisGenome.SetConnectionWeight(6, 12, 1.0) # TAGET_DISTANCE_Y -> MOVE_NORTH
        self.genesisGenome.SetConnectionWeight(6, 13, -1.0) # TAGET_DISTANCE_Y -> MOVE_SOUTH
        self.genesisGenome.SetConnectionWeight(5, 14, -1.0) # TAGET_DISTANCE_X -> MOVE_EAST
        self.genesisGenome.SetConnectionWeight(5, 15, 1.0) # TAGET_DISTANCE_X -> MOVE_WEST
        self.Genomes.append(self.genesisGenome)
        self.Breeds.append(Breed(self.genesisGenome))

    def GenerateGenesisAgent(self):
        genesisNet = NeuralNetwork()
        genesisNet.GenerateFromGenome(self.genesisGenome)
        position = pygame.Vector2(random.uniform(0.0, float(SCREEN_WIDTH)), random.uniform(0.0, float(SCREEN_HEIGHT)))
        return Agent(self.genesisGenome, genesisNet, position)
